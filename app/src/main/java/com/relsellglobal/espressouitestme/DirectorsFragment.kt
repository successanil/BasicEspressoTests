...
import com.relsellglobal.espressouitestme.databinding.FragmentDirectorsBinding

class DirectorsFragment : Fragment(){

    private val directors: ArrayList<String> = ArrayList()

    lateinit var binding : FragmentDirectorsBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater,R.layout.fragment_directors, container, false)
        return binding.root
    }
